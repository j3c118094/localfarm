...
<section class="container my-5">
    ...
    <!-- Pertanyaan-->
    <form action="" class="text-green mt-5-custom">
        <!-- NO 1 -->
        <div class="mb-3">
            ...
            <label for="Sangat Tahu">Sangat Tahu</label><br>
            <input type="radio" name="no_1" value="Cukup Tahu" class="mr-2">
            <label for="Cukup Tahu">Cukup Tahu</label><br>
            <input type="radio" name="no_1" value="Tidak Tahu" class="mr-2">
            <label for="Tidak Tahu">Tidak Tahu</label><br>
        </div>
        <!-- NO 2 -->
        <div class="mb-3">
            <h4 for="" class="font-weight-bold text-justify font-kuis">
        ...
        <div class="mb-3">
            ...
            <label for="Pernah">Pernah</label><br>
        ...
        <div class="mb-3">
            ...
            <label for="Sangat Membantu">Sangat Membantu</label><br>
            <input type="radio" name="no_4" value="Cukup Membantu" class="mr-2">
            <label for="Cukup Membantu">Cukup Membantu</label><br>
